...
//increase data buffer count to match skybyte (448MB)
#define AVAILABLE_DATA_BUFFER_ENTRY_COUNT				28672 // 448MiB / 16KiB not (16 * USER_DIES)
...
int RecordDataBufEntryDirty(unsigned int bufEntry);
